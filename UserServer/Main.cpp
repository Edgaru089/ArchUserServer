...
const string versionString = "1.1";
...
int main(int argc, char* argv[]) {
	...
	cout << "    Copyright (c) Edgaru089 of KEEER Entertainments Inc." << endl << endl;
	...
	if(!userServer.loadConfig("server.config")) {
		mlog << Log::FatalError << "[Main] Config loading failed! Exitiing!" << defLog;
		return EXIT_FAILURE;
	}
